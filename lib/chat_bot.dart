...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  final BackendService _backendService = BackendService(); // Backend service for interaction
  ...
  void initState() {
    ...
    _messages.add({
      'isUser': false,
      'text': "👋 Hey ${widget.username}, welcome to **FlutterBot**!\nHow can I assist you today?",
    });
  }
 ...
 void sendMessage() async {
  ...
  // Fetching response from Gemini model via BackendService
